  ...
  const faqs = [
    {
      ...
      answer:
        "Alter is an AI-powered legal assistant that helps attorneys manage their practice more efficiently.",
    },
    {
      question: "Do I need coding skills to use Alter ?",
      answer:
        "No, Alter is designed to be user-friendly and requires no coding skills whatsoever.",
    },
    {
      question: "Is Alter optimized for SEO ?",
      answer:
        "Yes, Alter includes built-in SEO optimization tools for your legal content and website.",
    },
    {
      question: "Can I customize Alter to fit my brand ?",
      answer:
        "Absolutely! Alter offers extensive customization options to match your law firm&apos;s branding.",
    },
    {
      question: "Does Alter include mobile responsiveness ?",
      answer:
        "Yes, Alter is fully responsive and works seamlessly across all devices and screen sizes.",
    },
  ];
      ...
      >
        ...
        >
          ...
          >
            {plan.isFree
              ? ""
              : `/${billingPeriod === "monthly" ? "user/month" : "user/year"}`}
          </Text>
        </View>
        ...
        >
          {plan.isFree
            ...
            : "Dedicated for Law students/researchers"}
        </Text>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View
          style={{
            ...
            paddingTop: isSmallScreen ? 60 : 40,
            paddingBottom: 24,
          }}
        >
          <View
          ...
          >
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 8,
                backgroundColor:
                  billingPeriod === "monthly" ? "#ffffff" : "transparent",
              }}
            >
              <Text
                style={{
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 8,
                backgroundColor:
                  billingPeriod === "yearly" ? "#ffffff" : "transparent",
                flexDirection: "row",
                alignItems: "center",
              }}
            >
            ...
            {plans.map((_, index) => (
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderRadius: 4,
                  backgroundColor:
                    currentPlanIndex === index ? "#FF8800" : "#E5E7EB",
                }}
              />
            ))}
          </View>
        ...
        {/* FAQ Section */}
        <View
          style={{ paddingHorizontal: 20, paddingTop: 48, paddingBottom: 32 }}
        >
          <View
            style={{
              flexDirection: "row",
