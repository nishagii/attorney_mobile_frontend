    ...
    <View style={{ flex: 1, backgroundColor: "#111827" }}>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => router.push("/lawyer/(tabs)/dashboard" as any)}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/lawyer/(tabs)/cases" as any)}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/lawyer/(tabs)/search" as any)}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/lawyer/(tabs)/payments" as any)}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/lawyer/(tabs)/profile" as any)}
        >
