  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f9fafb" }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        {/* Hero Section */}
        <View style={{ paddingHorizontal: horizontalPadding, paddingTop: isSmallScreen ? 40 : 32, paddingBottom: 24 }}>
          <View style={{
            flexDirection: 'row',
            alignItems: 'center',
            ...
            <Ionicons name="today" size={16} color="#5E788F" style={{ marginRight: 8 }} />
            <Text style={{
          ...
          <View style={{
            ...
            <View style={{
              ...
              <View style={{
                ...
                <Ionicons name="people" size={20} color="#FF8800" style={{ marginRight: 8 }} />
                <Text style={{
              ...
              <Text style={{
                ...
                {daySummaryData.clientsReached.count.toString().padStart(2, '0')}
              </Text>
              <Text style={{
                fontSize: isSmallScreen ? 11 : 12,
                color: "#6B7280",
            ...
            <View style={{
              ...
              <View style={{
                ...
                <Ionicons name="briefcase" size={20} color="#10B981" style={{ marginRight: 8 }} />
                <Text style={{
                  fontSize: isSmallScreen ? 12 : 14,
                  color: "#6B7280",
                  fontFamily: fonts.medium,
          ...
          {clientsReached.map((client, index) => (
            <View key={index} style={{
              ...
              <View style={{
                ...
                <Ionicons name="person-circle" size={24} color="#6B7280" style={{ marginRight: 12 }} />
                <Text style={{
          ...
          {newCases.map((caseItem, index) => (
            <View key={index} style={{
              ...
              <View style={{
                ...
                <Ionicons name="document-text" size={24} color="#10B981" style={{ marginRight: 12 }} />
                <Text style={{
                  fontSize: isSmallScreen ? 13 : 14,
                  color: "#000000",
                  fontFamily: fonts.medium,
