...
export default function DaySummary() {
  ...
  const daySummaryData = {
    clientsReached: { count: 3, total: 20 },
    ongoingCases: { count: 2 },
    closedCases: { count: 1, remaining: 10 },
    income: { today: "4000 LKR", month: "25780 LKR" }
  };
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f9fafb" }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        >
          ...
          >
            Here is your daily overview and performance summary
          </Text>
        </View>
